...
import static pt.ipg.application.testingcovid_19.database.Convert.contentValuesToHistory;

public class DBTableHistory implements BaseColumns {
    ...
    public DBTableHistory(SQLiteDatabase db) {
        this.db = db;
    }
    ...
    public long insert(ContentValues values) {
        ...
        String QUERY = ParseInsertSQL(TABLE_NAME, ALL_COLUMN, contentValuesToHistory(values).Values(), IS_STRING);
        rDB.query(QUERY);
        // Save on remote server
